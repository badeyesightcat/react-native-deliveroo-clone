import { Text, SafeAreaView, View, Image, TextInput, ScrollView } from 'react-native' // [important] import SafeAreaView from react-native for low import cost
    ...
    <SafeAreaView className='bg-white pt-5'>
      ...
      <View className='flex-row items-center space-x-2 pb-2 mx-4'>
        <View className='flex-row flex-1 space-x-2 bg-gray-200 p-3'>
          ...
          <TextInput placeholder='Restaurants and Cuisines' inputMode='default' />
        </View>
